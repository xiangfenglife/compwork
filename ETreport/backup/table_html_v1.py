...
class table_html:
    ...
    def __init__(self):
        ...
        self.End_name = u'End'
        self.table = None
        self.html_path = "/home/xbu/Downloads/log_html/"
    def gen_html(self, filepath, param=u"Responsible Tester"):
        file_lst = []
        date_lst = []
        param_lst = []
        if '/*' in filepath:
    ...
    def params(self, param):
        ...
        if isinstance(self.table, xlrd.sheet.Sheet):
            param_cols_num = self.get_index_cols(param)
            ...
            #print "csv2"
            param = 'test_case.test_instance.res_tester'
            for row in self.table:
                param_lst.append(row[str(param).lower()])
    ...
    def write_html(data_dic):
        ...
        return html(head, output_bodies)
...
if __name__ == "__main__":
    data = table_html()
    testers = u"Responsible Tester"
    file_name = u'/home/xbu/Downloads/log_table/*'
